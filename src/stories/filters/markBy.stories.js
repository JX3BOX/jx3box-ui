...
const meta = { title: 'Filters/markBy', component: markBy, parameters: { layout: 'fullscreen', shell: { enabled: true, placement: 'main', showLeftSidebar: false, showRightSidebar: false } } };
export default meta;

...
const meta = { title: 'Filters/zlpBy', component: zlpBy, parameters: { layout: 'fullscreen', shell: { enabled: true, placement: 'main', showLeftSidebar: false, showRightSidebar: false } } };
export default meta;

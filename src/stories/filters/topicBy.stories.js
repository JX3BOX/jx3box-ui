...
const meta = { title: 'Filters/topicBy', component: topicBy, parameters: { layout: 'fullscreen', shell: { enabled: true, placement: 'main', showLeftSidebar: false, showRightSidebar: false } } };
export default meta;

export default {
    ...
    commentUpload: {
        ...
        tipWithVideo: "最多上傳 {count} 個附件，支援 {types}，圖片不超過 {imageSize} MB，影片不超過 {videoSize} MB",
        exceed: "最多上傳 {count} 張圖片！",
        exceedWithVideo: "最多上傳 {count} 個附件！",
        onlyTypes: "僅支援 {types} 格式圖片！",
        onlyTypesWithVideo: "僅支援 {types} 格式的圖片和影片！",
        maxSize: "單張圖片大小不能超過 {size} MB！",
        maxSizeVideo: "單個影片大小不能超過 {size} MB！",
        uploadFailed: "圖片上傳失敗!",
        uploadFailedWithVideo: "附件上傳失敗!",
    },

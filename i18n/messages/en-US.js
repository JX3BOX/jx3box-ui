export default {
    ...
    commentUpload: {
        ...
        tipWithVideo: "Upload up to {count} attachments. Supported: {types}. Images up to {imageSize} MB, videos up to {videoSize} MB",
        exceed: "You can upload up to {count} images!",
        exceedWithVideo: "You can upload up to {count} attachments!",
        onlyTypes: "Only {types} image formats are supported!",
        onlyTypesWithVideo: "Only {types} image and video formats are supported!",
        maxSize: "Each image must be no larger than {size} MB!",
        maxSizeVideo: "Each video must be no larger than {size} MB!",
        uploadFailed: "Image upload failed!",
        uploadFailedWithVideo: "Attachment upload failed!",
    },
